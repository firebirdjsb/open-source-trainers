...
EXPECTED = [
    ...
    ("Class Test_C.InventoryComponent", "PickUpContainerItem", 0x418),
    ("Class Test_C.PickUpActor", "InventoryComponent", 0x2C0),
    ("Class Test_C.InventorySpatialContainerSettings", "ContainerSize", 0x38),
    ("Class Test_C.IRRItemPreset", "ItemDefinition", 0x30),
    ("Class Test_C.IRRItemPreset", "DefaultAttachments", 0x38),
    ("ScriptStruct Test_C.DefaultItem", "ItemType", 0x8),
    ("ScriptStruct Test_C.DefaultItem", "ItemPreset", 0x10),
    ("ScriptStruct Test_C.DefaultItem", "ItemDefinition", 0x18),
    ("ScriptStruct Test_C.DefaultItem", "DefaultAttachments", 0x20),
    ("ScriptStruct Test_C.DefaultItem", "RandomAttachmentParameters", 0x30),
    ("ScriptStruct Test_C.DefaultItem", "Count", 0x1E0),
